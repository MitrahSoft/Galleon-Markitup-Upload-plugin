...
<head>
	...
	<script src="markitup/jquery.dimensions.js" type="text/javascript"></script>
	<script src="markitup/ui.mouse.js" type="text/javascript"></script>
	<script src="markitup/ui.draggable.js" type="text/javascript"></script>
	<script src="markitup/ui.draggable.ext.js" type="text/javascript"></script>
	
    <script src="markitup/jquery.markitup.js" type="text/javascript"></script>
	<script src="markitup/InlineUpload.js" type="text/javascript"></script>
...
$(document).ready(function()	{
	...
	<div id="linkPlugin">
		<div class="toolbar"><a href="##" class="handle">Move</a> <a href="##" class="close">Close</a>    </div>
	    <div id="resultContainer" class="module">
